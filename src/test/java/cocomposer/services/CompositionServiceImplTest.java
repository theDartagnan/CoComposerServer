...
public class CompositionServiceImplTest {
    ...
    public void setUp() {
        ...
        this.testedService = new CompositionServiceImpl(compoRepo, memberRepo);
    ...
    public void testUpdateCompositionTitle() {
        ...
        String returnedTitle = this.testedService.updateCompositionTitle(compoId, newTitle);
    ...
    /**
     * Test of updateCompositionCollaborative method, of class CompositionServiceImpl.
     */
    @Test
    public void testUpdateCompositionCollaborative() {
        ...
        boolean returnedCollab = this.testedService.updateCompositionCollaborative(compoId, collaborative);
    ...
    /**
     * Test of deleteAllOwnedCompositionsFromUser method, of class CompositionServiceImpl.
     */
    @Test
